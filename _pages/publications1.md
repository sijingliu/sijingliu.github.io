...
* Sijing Liu\*, [Robust multigrid methods for discontinuous Galerkin discretizations of an elliptic optimal control problem](https://www.degruyter.com/document/doi/10.1515/cmam-2023-0132/html). _Computational Methods in Applied Mathematics_ (2024).
* Sijing Liu\*, Zhiyu Tan and Yi Zhang. [Discontinuous Galerkin methods for an elliptic optimal control problem with a general state equation and pointwise state constraints](https://www.sciencedirect.com/science/article/pii/S0377042723004387). _Journal of Computational and Applied Mathematics_ 437 (2024), 115494.
* Susanne C. Brenner, Sijing Liu and Li-yeng Sung. [Multigrid methods for an elliptic optimal control problem with pointwise state constraints](https://www.sciencedirect.com/science/article/pii/S259003742300002X). _Results in Applied Mathematics_ (2023).
...
* Susanne C. Brenner, Sijing Liu and Li-yeng Sung. [Multigrid methods for saddle point problems: optimality systems](https://www.sciencedirect.com/science/article/pii/S0377042720300248). _Journal of Computational and Applied Mathematics_ 372 (2020), 112733.
...
* (with Jinjin Zhang) BDDC preconditioner for HDG discretizations of an optimal control problem.
